...
#include "team_name_peppy_ru.ia8.inc"
#include "team_name_slippy_ru.ia8.inc"
#include "team_name_falco_ru.ia8.inc"
#include "falco_mark_ru.ci4.inc"
#include "peppy_mark_ru.ci4.inc"
#include "slippy_mark_ru.ci4.inc"
#include "bill_mark_ru.ci4.inc"
#include "james_mark_ru.ci4.inc"
#include "aBossLabelBossRu32x7.ci4.inc"
#include "sector_z_missile_mark_ru.ci4.inc"
...
static const Sf64RuTexture sf64_ru_common_textures[11] = {
    ...
    { 0x01024638u, sf64_ru_a_falco_mark_ru_ci4, 0x80 },
    /* Gameplay ally ship mark: Peppy. */
    { 0x010244D8u, sf64_ru_a_peppy_mark_ru_ci4, 0x80 },
    /* Gameplay ally ship mark: Slippy. */
    { 0x01024798u, sf64_ru_a_slippy_mark_ru_ci4, 0x80 },
};

/* Bill and James gameplay marks use the segment-0x0D native texture route. */
static const Sf64RuTexture sf64_ru_actor_mark_segment_d_textures[2] = {
    ...
    { 0x0D00B688u, sf64_ru_a_bill_mark_ru_ci4, 0x80 },
    /* James gameplay ally mark: exact segment-0x0D native route from datasyms. */
    { 0x0D00B7F0u, sf64_ru_a_james_mark_ru_ci4, 0x80 },
};
...
static const Sf64RuTexture sf64_ru_text_status_textures[11] = {
    ...
    { 0x05006CB0u, sf64_ru_a_text_peppy_native_48x10_ia8, 48 * 10 },
    { 0x05006E90u, sf64_ru_a_text_slippy_native_56x10_ia8, 56 * 10 },
    { 0x05006B30u, sf64_ru_a_text_falco_native_48x8_ia8, 48 * 8 },
};
...
static const Sf64RuTexture sf64_ru_sector_z_missile_textures[1] = {
    { 0x06004458u, sf64_ru_a_sz_missile_mark_ru_32x16_ci4, 32 * 16 / 2 },
};
...
static void sf64_ru_patch_briefing_title_tables(void) {
    if (gSceneId != 2) {
        return;
    }

    /* Native map/briefing title-card route, native.
    ...
    /* Lower briefing subtitles through native sPlanetTitleCards[].
       ...
       Area 6 lower subtitle: Through the Middle.
...
static void sf64_ru_apply_meteo_title_card_pointer(void) {
...
static void sf64_ru_apply_katina_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_aquas_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_sector_y_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_sector_x_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_solar_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_zoness_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_titania_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_macbeth_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_sector_z_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_bolse_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_area6_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_venom1_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_apply_venom2_title_card_pointer(void) {
    s32 level_index;
...
static void sf64_ru_suppress_venom_upper_title_begin(void) {
    ...
    /* HUD_TitleCard_Draw calls HUD_VenomTitleCard_Draw only for the special upper
       ...
       previous Lib_TextureRect_IA8 row-blank route. */
...
void sf64_ru_after_load_scene_setup(void) {
    ...
    if ((gSceneId == 2) && (gSegments[6] != 0)) {
        sf64_ru_patch_briefing_title_tables();
...
void sf64_ru_before_map_draw_table_patch(void) {
    sf64_ru_patch_briefing_title_tables();
}
...
void sf64_ru_before_hud_title_card_draw(f32 x, f32 y) {
    sf64_ru_patch_venom_title_card_entries_safe();
    sf64_ru_apply_meteo_title_card_pointer();
    sf64_ru_apply_katina_title_card_pointer();
    sf64_ru_apply_aquas_title_card_pointer();
    sf64_ru_apply_sector_y_title_card_pointer();
    sf64_ru_apply_sector_x_title_card_pointer();
    sf64_ru_apply_solar_title_card_pointer();
    sf64_ru_apply_zoness_title_card_pointer();
    sf64_ru_apply_titania_title_card_pointer();
    sf64_ru_apply_macbeth_title_card_pointer();
    sf64_ru_apply_sector_z_title_card_pointer();
    sf64_ru_apply_bolse_title_card_pointer();
    sf64_ru_apply_area6_title_card_pointer();
    sf64_ru_apply_venom1_title_card_pointer();
    sf64_ru_apply_venom2_title_card_pointer();
    sf64_ru_copy_fortuna_title_card_direct();
    sf64_ru_blank_native_mission_number();
